		...
		<div class="mx-auto max-w-xl py-16 sm:py-24">
			...
			<div class="mt-12">
				<ul role="list" class="mt-4 divide-y divide-gray-200 border-t border-b border-gray-200">
					<li v-for="(link, linkIdx) in navigation" :key="linkIdx" class="relative flex items-start space-x-4 py-6">
						<div class="flex-shrink-0">
							<span class="flex h-12 w-12 items-center justify-center rounded-lg bg-primary-50">
								<component :is="link.icon" class="h-6 w-6 text-primary-700" aria-hidden="true" />
							</span>
						</div>
						<div class="min-w-0 flex-1">
							<h3 class="text-base font-medium text-gray-900">
								<span class="rounded-sm focus-within:ring-2 focus-within:ring-primary-500 focus-within:ring-offset-2">
									<RouterLink  class="focus:outline-none" :to="link.href">
